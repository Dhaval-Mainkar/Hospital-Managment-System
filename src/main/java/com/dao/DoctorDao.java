...
public class DoctorDao {
	...
	//this is to display doctors in view doctor page
	public List<Doctor> getAllDoctor() {
		...
		try {
			...
			ResultSet rs = ps.executeQuery();//result set contains current row
			while (rs.next()) {
				d = new Doctor();
				d.setId(rs.getInt(1));
	...
	//this is to display doctors in admin's view doctor page
	...
	public Doctor login(String email,String psw) {
		...
		try {
			...
			while(rs.next()){
				d = new Doctor();
				d.setId(rs.getInt(1));
				d.setFullName(rs.getString(2)); //this is asper the rank of the column in the dataset
				d.setDob(rs.getString(3));
				d.setQualification(rs.getString(4));
				d.setSpecialist(rs.getString(5));
				d.setEmail(rs.getString(6));
	...
	//to display numbers on admin dashboard
	...
	//to display numbers on doctor dashboard
