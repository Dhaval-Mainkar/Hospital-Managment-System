...
public class UserDao {
	...
	public boolean register(User u) {
		...
		try {
			...
			PreparedStatement ps=conn.prepareStatement(sql); //prepared statement is used to execute the same (or similar) SQL statements repeatedly with high efficiency
